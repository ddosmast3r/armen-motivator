...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-eerie_black via-black_olive to-eerie_black overflow-hidden pt-20 pb-6">
      {/* Background Pattern */}
